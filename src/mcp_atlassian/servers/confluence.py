...
async def upload_attachment(
    ...
    filename: Annotated[
        str,
        Field(description="The name for the attachment file"),
    ],
    content: Annotated[
        str,
        Field(
            description=(
                "Base64-encoded file content. The file content must be encoded as base64 string."
            ),
        ),
    ],
    comment: Annotated[
    ...
    """Upload an attachment to a Confluence page using base64-encoded content.
